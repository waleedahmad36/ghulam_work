...
function RevealVideoOnScrollSection() {
  ...
  return (
    ...
    >
      <video
        ref={videoRef}
        src="https://video.wixstatic.com/video/f415e2_20e086d6936943d8a3922376246442ee/1080p/mp4/file.mp4"
        muted
        autoPlay
        loop
        playsInline
...
export default RevealVideoOnScrollSection;
