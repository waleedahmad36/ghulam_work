...
const Process = () => {
  return (
    <div   className=" flex flex-col bg-white justify-center items-center text-black badoni" >
        <div   className="bg-black h-[30vh] w-[1px]" />
        <h3  className="text-7xl" >Our Process</h3>
